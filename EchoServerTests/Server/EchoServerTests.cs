...
namespace EchoServerTests.Server
{
    [TestFixture]
    public class EchoServerTests
    {
        ...
        private EchoServer.Server.EchoServer _server;
        ...
        public void SetUp()
        {
            ...
            _server = new EchoServer.Server.EchoServer(_mockListener.Object, _mockHandler.Object);
        }
        ...
        public void Constructor_ThrowsArgumentNullException_WhenListenerIsNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() =>
                new EchoServer.Server.EchoServer(null, _mockHandler.Object));
        }
        ...
        public void Constructor_ThrowsArgumentNullException_WhenHandlerIsNull()
        {
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() =>
                new EchoServer.Server.EchoServer(_mockListener.Object, null));
        }
